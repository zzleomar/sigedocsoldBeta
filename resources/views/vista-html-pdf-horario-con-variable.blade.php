	...
	<tbody>
		...
		<tr>   @foreach($Horario as $R)
			...
			<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:8pt"><span style="font-family:Calibri,sans-serif"><em><span style="color:#17365d">{{$R->nombres}} {{$R->apellidos}}</span></em></span></span></p>
                        ...
                        @endforeach 
                        @foreach($Asignado as $Z) 
			<td style="width:63.8pt">
			<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:8pt"><span style="font-family:Calibri,sans-serif"><span style="color:#17365d">{{$Z->dia}}</span></span></span></p>
			</td>
			<td style="width:2.0cm">
			<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:8pt"><span style="font-family:Calibri,sans-serif"><span style="color:#17365d">{{$Z->entrada}}</span></span></span></p>
			</td>
			<td style="width:70.85pt">
			<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:8pt"><span style="font-family:Calibri,sans-serif"><span style="color:#17365d">{{$Z->salida}}</span></span></span></p>
			</td>
			<td style="width:66.45pt">
			<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:8pt"><span style="font-family:Calibri,sans-serif"><span style="color:#17365d">{{$Z->nombre}}</span></span></span></p>
			</td>
