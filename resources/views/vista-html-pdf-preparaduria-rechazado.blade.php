...
<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:10pt"><span style="font-family:&quot;Times New Roman&quot;,serif"><span style="font-family:&quot;Bookman Old Style&quot;,&quot;serif&quot;">ASIGNATURAS CURSADAS EN EL SEMESTRE ACTUAL:
               ...
               <strong style="font-size:9pt">  {{$materia->codigo}} - {{$materia->nombre}} </strong>  </span></span></span></p>
@endforeach
<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:10pt"><span style="font-family:&quot;Times New Roman&quot;,serif"><span style="font-family:&quot;Bookman Old Style&quot;,&quot;serif&quot;">SOLICITUD: <strong>RECHAZADA </strong> OBSERVACION: {{$preparador->observacion}}</span></span></span></p>
...
<table cellspacing="0" class="MsoTableGrid" style="border-collapse:collapse; border:undefined">
	<tbody>
		<tr>
			...
			<p style="margin-left:0cm; margin-right:0cm; text-align:center">C.I.{{ $preparador->cedula}}
&nbsp;</p>
			</td>
