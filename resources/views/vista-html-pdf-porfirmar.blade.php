...
@foreach($Sello as $S)
<p style="text-align:center"><span style="font-family:Arial,Helvetica,sans-serif"><span style="font-size:12px"><strong><img alt="" src="{{ asset('/file/foto/'.$S->sello)}}" width="150" height="150" /></strong></span></span></p>
            @endforeach&nbsp;             
