...
@endforeach
<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:10pt"><span style="font-family:&quot;Times New Roman&quot;,serif"><span style="font-family:&quot;Bookman Old Style&quot;,&quot;serif&quot;">SOLICITUD: <strong> REPROBADA POR </strong>    @foreach($Escuela as $P)
                  {{$P->nombre}}
                @endforeach OBSERVACION: {{$preparador->observacion}}</span></span></span></p>
