...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ruta de Ubicación del Documento</li>
      </ol>
    </section>
  <!-- Main content -->
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="timeline">
              ...
              <div class="timeline-item">
               ...
               <p> <div class="timeline-body fa fa-map-marker">
                  {{$item->nombre_dependencia}}</p>
                   <p>Código Planilla:    {{$item->codigo_plantilla}}</p>
                    <p>Por: {{$item->nombres}}                  {{$item->apellidos}}</p>
                   <p> Descripción Documento:    {{$item->descripcion_documento}}</p>
                </div>
              </div>
            </li>
             @endif
            <!-- END timeline item -->
            <!-- timeline item -->
            @if($item->id_estados==2 || $item->id_estados==17)
                 <li class="time-label">
                  <span class="bg-green">
                   {{$item->fecha}}
                  </span>
            ...
            <li>
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-body fa fa-map-marker">
                    {{$item->nombre_dependencia}}</p>
                     <p>Por: {{$item->nombres}}                  {{$item->apellidos}}</p>
                   <p>Codigo Planilla:    {{$item->codigo_plantilla}}</p>
