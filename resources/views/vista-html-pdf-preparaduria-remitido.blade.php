...
<p style="margin-left:0cm; margin-right:0cm; text-align:center"><strong><span style="font-family:Arial,sans-serif"><span style="font-size:12px">RESULTADOS DEL CONCURSO DE PREPARADORES DOCENTES {{$preparador->periodo}}</span></span></strong></p>

<p style="margin-left:0cm; margin-right:0cm; text-align:center"><span style="font-family:Arial,sans-serif"><span style="font-size:12px">BACHILLERES ELEGIBLES</span></span></p>
